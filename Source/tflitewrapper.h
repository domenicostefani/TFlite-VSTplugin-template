/*
 * Put here your TensorFlow Lite code
 * 
 * The code provided here as an example is from a tflite wrapper developed previously (https://github.com/domenicostefani/deep-classf-runtime-wrappers)
 *
 */
// #pragma once
